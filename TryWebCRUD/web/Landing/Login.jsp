<%-- 
    Document   : Login
    Created on : 29 Apr 2024, 12.09.05
...
<html>
    <head>
        ...
        <!-- Custom CSS -->
        <link href="../Landing/Login.css" rel="stylesheet" type="text/css" />
    </head>
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><i class='bx bxl-java'><b> KELOMPOK 4</b></i>
                </a>
